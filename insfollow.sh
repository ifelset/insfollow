#!/bin/bash
# insfollow v2.0
# recoded by: if else Tools
# github.com/ifelset/insfollow
# If you want to use your rights on this code, give me the credits, please, read the License
...
echo -e "\e[1;91m ═╩═\e[1;92m         \e[1;91m╩   by - \e[1;92mIf else Tools"
